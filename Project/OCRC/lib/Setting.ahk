SettingGUI() {
    ...
    Setting.AddGroupBox("x20 y50 w325 h230", "基础设置")
    Setting.AddText("x15 y80 w90 h25 Right", "API Key")
    ...
    Setting.AddGroupBox("x20 y290 w325 h310", "默认选项")
    Setting.AddText("x15 y320 w135 h25 Right", "默认排版")
    ...
    Setting.AddGroupBox("x20 y50 w325 h120", "基础设置")
    Setting.AddText("x15 y80 w90 h25 Right", "App ID")
    ...
    Setting.AddDropDownList("x+15 w215 vLaTeX_DefaultSelect AltSubmit Choose" OCRC_Configs["LaTeX"]["LaTeX_DefaultSelect"], ["LaTeX", "行内公式", "行间公式"]).OnEvent("Change", UpdateVar)
    Setting["LaTeX_DefaultSelect"].ToolTip := "设置默认选择的公式类型`nLaTeX：纯 LaTeX 代码（无数学分隔符）。`n行内公式：行内公式。`n行间公式：行间公式。`n文本公式：混排文本和公式时默认选择，智能区分文本和公式。"
...
CreateConfig() {
    ...
    IniWrite(2,     OCRC_ConfigFilePath, "BaiduOCR", "BaiduOCR_TranslateFrom")
    ...
    IniWrite(1, OCRC_ConfigFilePath, "LaTeX", "LaTeX_DefaultSelect")
}