...
SettingGUI() {
    ...
    Setting.AddGroupBox("x20 y50 w325 h100", "OCR 启用")
    Setting.AddCheckBox("x32 y80 w130 vBasic_BaiduOCROnOff Right Checked" OCRC_Configs["Basic"]["Basic_BaiduOCROnOff"], "BaiduOCR").OnEvent("Click", SwitchHotkey)
    Setting["Basic_BaiduOCROnOff"].ToolTip := "设置是否启用百度 OCR 识别"
    Setting.AddCheckBox("x32 y+15 w130 vBasic_MathpixOCROnOff Right Checked" OCRC_Configs["Basic"]["Basic_MathpixOCROnOff"], "MathpixOCR").OnEvent("Click", SwitchHotkey)
    Setting["Basic_MathpixOCROnOff"].ToolTip := "设置是否启用 Mathpix OCR 识别"

    Setting.AddGroupBox("x20 y160 w325 h150", "截图")
    ...
    Setting.AddText("x215 y190 w20 h25 Left", "秒")
    ...
    Setting.AddText("x215 y230 w40 h25 Left", "毫秒")
    ...
    Setting.AddGroupBox("x20 y320 w325 h75", "OCRC")
    ...
    Setting.AddGroupBox("x20 y50 w325 h260", "基础设置")
    Setting.AddText("x15 y80 w90 h25 Right", "热键")
    Setting.AddHotkey("x+15 w215 h25 vBaiduOCR_Hotkey", OCRC_Configs["BaiduOCR"]["BaiduOCR_Hotkey"]).OnEvent("Change", UpdateHotkey)
    Setting["BaiduOCR_Hotkey"].ToolTip := "设置百度 OCR 的热键。如果不使用百度 OCR 则需要在基础设置关闭"
    Setting.AddText("x15 y+15 w90 h25 Right", "API Key")
    Setting.AddEdit("x+15 w215 h25 vBaiduOCR_APIKey", OCRC_Configs["BaiduOCR"]["BaiduOCR_APIKey"]).OnEvent("Change", UpdateVar)
    Setting["BaiduOCR_APIKey"].ToolTip := "设置百度 OCR 的 API Key。如果不使用百度 OCR 则无需设置"
    Setting.AddText("x15 y+15 w90 h25 Right", "Secret Key")
    Setting.AddEdit("x+15 w215 h25 vBaiduOCR_SecretKey", OCRC_Configs["BaiduOCR"]["BaiduOCR_SecretKey"]).OnEvent("Change", UpdateVar)
    Setting["BaiduOCR_SecretKey"].ToolTip := "设置百度 OCR 的 Secret Key。如果不使用百度 OCR 则无需设置"
    Setting.AddText("x15 y+15 w90 h25 Right", "识别语言")
    Setting.AddDropDownList("x+15 w215 vBaiduOCR_LanguageType AltSubmit Choose" OCRC_Configs["BaiduOCR"]["BaiduOCR_LanguageType"], Map2Array(OCRC_Configs["BaiduOCR_LanguageTypes"])).OnEvent("Change", UpdateVar)
    ...
    Setting.AddDropDownList("x+15 w215 vBaiduOCR_RecognitionType AltSubmit Choose" OCRC_Configs["BaiduOCR"]["BaiduOCR_RecognitionType"], Map2Array(BaiduOCR_RecognitionTypes, 0)).OnEvent("Change", UpdateVar)
    ...
    Setting.AddGroupBox("x20 y320 w325 h310", "默认选项")
    Setting.AddText("x15 y350 w135 h25 Right", "默认排版")
    ...
    Setting.AddDropDownList("x+15 w170 vBaiduOCR_TranslateFrom AltSubmit Choose" OCRC_Configs["BaiduOCR"]["BaiduOCR_TranslateFrom"], Map2Array(OCRC_Configs["TranslateLanguages"])).OnEvent("Change", UpdateVar)
    Setting["BaiduOCR_TranslateFrom"].ToolTip := ""
    Setting.AddText("x15 y+15 w135 h25 Right", "默认翻译结果语言")
    Setting.AddDropDownList("x+15 w170 vBaiduOCR_TranslateTo AltSubmit Choose" OCRC_Configs["BaiduOCR"]["BaiduOCR_TranslateTo"], Map2Array(OCRC_Configs["TranslateLanguages"])).OnEvent("Change", UpdateVar)
    Setting["BaiduOCR_TranslateTo"].ToolTip := ""
    ...
    Setting.AddGroupBox("x20 y50 w325 h150", "基础设置")
    Setting.AddText("x15 y80 w90 h25 Right", "热键")
    Setting.AddHotkey("x+15 w215 h25 vMathpixOCR_Hotkey", OCRC_Configs["MathpixOCR"]["MathpixOCR_Hotkey"]).OnEvent("Change", UpdateHotkey)
    ...
    Setting.AddEdit("x+15 w215 h25 vMathpixOCR_AppID", OCRC_Configs["MathpixOCR"]["MathpixOCR_AppID"]).OnEvent("Change", UpdateVar)
    ...
    Setting.AddEdit("x+15 w215 h25 vMathpixOCR_AppKey", OCRC_Configs["MathpixOCR"]["MathpixOCR_AppKey"]).OnEvent("Change", UpdateVar)
    Setting["MathpixOCR_AppKey"].ToolTip := "设置 Mathpix OCR 的 App Key。如果不使用 Mathpix OCR 则无需设置"

    Setting.AddGroupBox("x20 y210 w325 h75", "默认选项")
    Setting.AddText("x15 w90 y240 h25 Right", "默认选择")
    Setting.AddDropDownList("x+15 w215 vMathpixOCR_DefaultSelect AltSubmit Choose" OCRC_Configs["MathpixOCR"]["MathpixOCR_DefaultSelect"], ["LaTeX", "行内公式", "行间公式"]).OnEvent("Change", UpdateVar)
...
CreateConfig() {
    ...
    IniWrite(1,     OCRC_ConfigFilePath, "BaiduOCR", "BaiduOCR_TranslateFrom")
    IniWrite(1,     OCRC_ConfigFilePath, "BaiduOCR", "BaiduOCR_TranslateTo")
