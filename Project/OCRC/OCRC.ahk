...
global BaiduOCR_RecognitionTypes_key := [
    "general_basic",
    "accurate_basic",
    "handwriting",
    "webimage",
...
global BaiduOCR_TranslateEngines_key := [
    "谷歌翻译",
    "腾讯翻译",
]
...
global BaiduOCR_TranslateTypes_key   := [
    "自动检测",
    "英->中",
    "中->英",
    "繁->简",
...
global BaiduOCR_SearchEngines := Map()
SearchEnginesKeys := StrSplit(IniRead(OCRC_ConfigFilePath, "BaiduOCR_SearchEngines"), "`n")
for key_index, key in SearchEnginesKeys {
    ConfigValues := StrSplit(key, "=", , 2)
    BaiduOCR_SearchEngines[ConfigValues[1]] := ConfigValues[2]
}
global BaiduOCR_SearchEngines_key := []
for key, value in BaiduOCR_SearchEngines
    BaiduOCR_SearchEngines_key.Push(key)

UpdateGlobalVar()

global BaiduOCR_HotkeyTemp := OCRC_Configs["BaiduOCR_Hotkey"], MathpixOCR_HotkeyTemp := OCRC_Configs["MathpixOCR_Hotkey"]
if OCRC_Configs["Basic_BaiduOCROnOff"]
    Hotkey(OCRC_Configs["BaiduOCR_Hotkey"], OCRC_BaiduOCR, "On")
if OCRC_Configs["Basic_MathpixOCROnOff"]
    Hotkey(OCRC_Configs["MathpixOCR_Hotkey"], OCRC_MathpixOCR, "On")
...
OCRC_BaiduOCR(ThisHotkey) {
    ...
    if base64string := PrepareOCR(False)
        BaiduOCR := Baidu(
            Map(
                "paragraph",   "true",
                "probability",   OCRC_Configs["BaiduOCR_ProbabilityType"] ? "true" : "false",
                "language_type", "CHN_ENG", ; TODO Add custom language type
            ),
            Map(
                "api_key",           OCRC_Configs["BaiduOCR_APIKey"],
                "secret_key",        OCRC_Configs["BaiduOCR_SecretKey"],
                "token",             OCRC_Configs["BaiduOCR_Token"],
                "token_expiration",  OCRC_Configs["BaiduOCR_TokenExpiration"],
                "image_base64",      base64string,
                "recognition_type",  BaiduOCR_RecognitionTypes_key[OCRC_Configs["BaiduOCR_RecognitionType"]],
                "probability_type",  OCRC_Configs["BaiduOCR_ProbabilityType"],
                "format_style",      OCRC_Configs["BaiduOCR_FormatStyle"],
                "punctuation_style", OCRC_Configs["BaiduOCR_PunctuationStyle"],
                "space_style",       OCRC_Configs["BaiduOCR_SpaceStyle"],
                "translate_engine",  OCRC_Configs["BaiduOCR_TranslateEngine"],
                "translate_proxy",   OCRC_Configs["Advance_GoogleTranslateProxy"],
                "translate_type",    OCRC_Configs["BaiduOCR_TranslateType"],
                "search_engine",     OCRC_Configs["BaiduOCR_SearchEngine"],
                "close_and_search",  OCRC_Configs["BaiduOCR_CloseAndSearch"],
            )
        )
}
...
OCRC_MathpixOCR(ThisHotkey) {
    ...
    if base64string := PrepareOCR(True)
        MathpixOCR := Mathpix(
            Map(
                "math_inline_delimiters",  OCRC_LaTeXInlineStyles[OCRC_Configs["LaTeX_InlineStyle"]],
                "math_display_delimiters", OCRC_LaTeXDisplayStyles[OCRC_Configs["LaTeX_DisplayStyle"]],
                "default_select",           OCRC_Configs["MathpixOCR_DefaultSelect"],
            ),
            Map(
                "app_id",       OCRC_Configs["MathpixOCR_AppID"],
                "app_key",      OCRC_Configs["MathpixOCR_AppKey"],
                "image_base64", base64string,
            )
        )
}
...
SettingGUI() {
    ...
    Setting.AddCheckBox("x32 y80 w115 vBasic_BaiduOCROnOff Right Checked" OCRC_Configs["Basic_BaiduOCROnOff"], "BaiduOCR").OnEvent("Click", SwitchHotkey)
    Setting["Basic_BaiduOCROnOff"].ToolTip := "设置是否启用百度 OCR 识别"
    Setting.AddCheckBox("x32 y+15 w115 vBasic_MathpixOCROnOff Right Checked" OCRC_Configs["Basic_MathpixOCROnOff"], "MathpixOCR").OnEvent("Click", SwitchHotkey)
    ...
    Setting.AddEdit("x+15 w145 h25 vAdvance_GoogleTranslateProxy", OCRC_Configs["Advance_GoogleTranslateProxy"]).OnEvent("Change", UpdateVar)
    ...
    Setting.AddEdit("x+15 w145 h25 vAdvance_TencentTranslateSecretID", OCRC_Configs["Advance_TencentTranslateSecretID"]).OnEvent("Change", UpdateVar)
    ...
    Setting.AddEdit("x+15 w145 h25 vAdvance_TencentTranslateSecretKey", OCRC_Configs["Advance_TencentTranslateSecretKey"]).OnEvent("Change", UpdateVar)
    ...
    Setting.AddHotkey("x+15 w200 h25 vBaiduOCR_Hotkey", OCRC_Configs["BaiduOCR_Hotkey"]).OnEvent("Change", UpdateHotkey)
    Setting["BaiduOCR_Hotkey"].ToolTip := "设置百度 OCR 的热键。如果不使用百度 OCR 则需要在基础设置关闭"
    Setting.AddText("x15 y+15 w90 h25 Right", "API Key")
    Setting.AddEdit("x+15 w200 h25 vBaiduOCR_APIKey", OCRC_Configs["BaiduOCR_APIKey"]).OnEvent("Change", UpdateVar)
    Setting["BaiduOCR_APIKey"].ToolTip := "设置百度 OCR 的 API Key。如果不使用百度 OCR 则无需设置"
    Setting.AddText("x15 y+15 w90 h25 Right", "Secret Key")
    Setting.AddEdit("x+15 w200 h25 vBaiduOCR_SecretKey", OCRC_Configs["BaiduOCR_SecretKey"]).OnEvent("Change", UpdateVar)
    Setting["BaiduOCR_SecretKey"].ToolTip := "设置百度 OCR 的 Secret Key。如果不使用百度 OCR 则无需设置"
    Setting.AddText("x15 y+15 w90 h25 Right", "识别类型")
    Setting.AddDropDownList("x+15 w200 vBaiduOCR_RecognitionType AltSubmit Choose" OCRC_Configs["BaiduOCR_RecognitionType"], ["通用文字（标准）识别", "通用文字（高精度）识别", "手写文字识别", "网络图片文字识别"]).OnEvent("Change", UpdateVar)
    ...
    Setting.AddCheckBox("x32 y+15 w90 vBaiduOCR_ProbabilityType Right Check3 Checked" OCRC_Configs["BaiduOCR_ProbabilityType"], "置信度").OnEvent("Click", UpdateVar)
    ...
    Setting.AddDropDownList("x+15 w170 vBaiduOCR_FormatStyle AltSubmit Choose" OCRC_Configs["BaiduOCR_FormatStyle"], ["智能段落", "合并多行", "拆分多行"]).OnEvent("Change", UpdateVar)
    ...
    Setting.AddDropDownList("x+15 w170 vBaiduOCR_PunctuationStyle AltSubmit Choose" OCRC_Configs["BaiduOCR_PunctuationStyle"], ["智能标点", "原始结果", "中文标点", "英文标点"]).OnEvent("Change", UpdateVar)
    ...
    Setting.AddDropDownList("x+15 w170 vBaiduOCR_SpaceStyle AltSubmit Choose" OCRC_Configs["BaiduOCR_SpaceStyle"], ["智能空格", "原始结果", "去除空格"]).OnEvent("Change", UpdateVar)
    ...
    Setting.AddDropDownList("x+15 w170 vBaiduOCR_TranslateEngine AltSubmit Choose" OCRC_Configs["BaiduOCR_TranslateEngine"], BaiduOCR_TranslateEngines_key).OnEvent("Change", UpdateVar)
    Setting["BaiduOCR_TranslateEngine"].ToolTip := "设置默认翻译引擎（目前仅「谷歌翻译」引擎可用，且可能需要配置代理）"
    Setting.AddText("x15 y+15 w120 h25 Right", "默认翻译类型")
    Setting.AddDropDownList("x+15 w170 vBaiduOCR_TranslateType AltSubmit Choose" OCRC_Configs["BaiduOCR_TranslateType"], BaiduOCR_TranslateTypes_key).OnEvent("Change", UpdateVar)
    ...
    Setting.AddDropDownList("x+15 w170 vBaiduOCR_SearchEngine AltSubmit Choose" OCRC_Configs["BaiduOCR_SearchEngine"], BaiduOCR_SearchEngines_key).OnEvent("Change", UpdateVar)
    Setting["BaiduOCR_SearchEngine"].ToolTip := "设置默认搜索引擎。以下为默认选项（可在配置文件中移除或添加）：`n百度：百度搜索。`n谷歌：谷歌搜索。`n必应：必应搜索。`n百度百科：百度百科搜索。`n维基百科：维基百科搜索。"
    Setting.AddCheckBox("x18 y+15 w180 vBaiduOCR_CloseAndSearch Right Checked" OCRC_Configs["BaiduOCR_CloseAndSearch"], "搜索时关闭结果窗口").OnEvent("Click", UpdateVar)
    ...
    Setting.AddText("x15 y80 w90 h25 Right", "热键")
    Setting.AddHotkey("x+15 w200 h25 vMathpixOCR_Hotkey", OCRC_Configs["MathpixOCR_Hotkey"]).OnEvent("Change", UpdateHotkey)
    ...
    Setting.AddEdit("x+15 w200 h25 vMathpixOCR_AppID", OCRC_Configs["MathpixOCR_AppID"]).OnEvent("Change", UpdateVar)
    ...
    Setting.AddEdit("x+15 w200 h25 vMathpixOCR_AppKey", OCRC_Configs["MathpixOCR_AppKey"]).OnEvent("Change", UpdateVar)
    ...
    Setting.AddDropDownList("x+15 w200 vMathpixOCR_DefaultSelect AltSubmit Choose" OCRC_Configs["MathpixOCR_DefaultSelect"], ["LaTeX", "行内公式", "行间公式"]).OnEvent("Change", UpdateVar)
    ...
    Setting.AddDropDownList("x+15 w200 vLaTeX_InlineStyle AltSubmit Choose" OCRC_Configs["LaTeX_InlineStyle"], ["$...$", "\(...\)"]).OnEvent("Change", UpdateVar)
    Setting["LaTeX_InlineStyle"].ToolTip := "设置默认行内公式格式"
    Setting.AddText("x15 y+15 w90 h25 Right", "行间公式")
    Setting.AddDropDownList("x+15 w200 vLaTeX_DisplayStyle AltSubmit Choose" OCRC_Configs["LaTeX_DisplayStyle"], ["$$...$$", "\[...\]"]).OnEvent("Change", UpdateVar)
...
PrepareOCR(base64_front) {
    ...
    base64string := Img2Base64(base64_front, OCRC_Configs["Advance_EBto64SQuality"])
    A_Clipboard := ClipSaved, ClipSaved := ""
    return base64string
}
...
SwitchHotkey(CtrlObj, *) => (UpdateVar(CtrlObj), Hotkey(OCRC_Configs["BaiduOCR_Hotkey"], OCRC_BaiduOCR, CtrlObj.Value ? "On" : "Off"))